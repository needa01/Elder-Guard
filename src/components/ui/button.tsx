  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary-hover shadow-button hover:shadow-lg transform hover:-translate-y-1 text-base font-semibold",
        care: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-soft transform hover:-translate-y-0.5",
        emergency: "bg-safety-orange text-white hover:bg-safety-orange/90 shadow-button animate-pulse-slow font-semibold",
      },
      size: {
