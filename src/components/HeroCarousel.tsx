...
const slides = [
  {
    ...
    description:
      "Advanced AI monitoring system that watches over your loved ones 24/7, providing instant alerts when help is needed most.",
    ctaText: "Try Dashboard",
    ctaText2: "Explore Cameras",
    ctaHref: "/dashboard",
    ctaHref2: "/cameras",
  ...
  },
  {
    ...
    description:
      "Intelligent guidance system that helps coordinate emergency responses, ensuring the fastest and most appropriate care.",
    ctaText: "Try the Coach",
    ctaText2: "Learn More",
    ctaHref: "/dashboard",
    ctaHref2: "/about",
    ctaVariant: "hero" as const,
  },
  {
    ...
    description:
      "Created by healthcare professionals who understand the challenges of elder care and the importance of reliable monitoring.",
    ctaText: "Get Started",
